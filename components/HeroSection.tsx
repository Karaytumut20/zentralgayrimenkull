  ...
  const slides = [
    {
      ...
      description:
        lang === "tr"
          ...
          : "Transparent and professional management processes protecting your property.",
      tags:
        lang === "tr"
          ? ["Şeffaf Yönetim", "Arsa & Kira Yönetimi", "Hukuki Güvence"]
          : ["Transparent Management", "Land & Rent Mng.", "Legal Assurance"],
    },
    {
      id: 2,
      ...
      description:
        lang === "tr"
          ...
          : "End-to-end real estate solutions from buying to selling.",
      tags:
        lang === "tr"
          ? ["Alım & Satım", "Değerleme", "Yasal Süreç Takibi"]
          : ["Buy & Sell", "Valuation", "Legal Process"],
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-20 h-full flex flex-col justify-center lg:flex-row lg:items-center gap-10 lg:gap-24 pt-28 pb-12 lg:py-0">
        <div className="lg:w-1/2 text-white animate-in slide-in-from-left duration-1000 text-center lg:text-left pointer-events-none">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-serif font-medium leading-[1.1] mb-6 lg:mb-8 drop-shadow-2xl">
            {lang === "tr" ? "Gayrimenkulde" : "The Center of"} <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-100 to-gray-300 font-semibold drop-shadow-sm pb-2 inline-block">
          ...
          <p className="text-gray-200 text-base sm:text-lg leading-relaxed max-w-lg mx-auto lg:mx-0 font-light drop-shadow-md">
            {lang === "tr"
              ? "Yatırımlarınızı şansa bırakmayın. 7 yılı aşkın tecrübe ile geleceğinizi inşa ediyoruz."
              : "Don't leave your investments to chance. We build your future with over 7 years of experience."}
          </p>
        </div>
