...
const services: ServiceItem[] = [
  {
    ...
    longDescription: (
      <div className="space-y-4">
        <p>
          Konya Organize Sanayi Bölgeleri (OSB) başta olmak üzere, üretim ve
          depolama ihtiyaçlarına yönelik anahtar teslim projeler geliştiriyoruz.
          Yüksek tavan, güçlendirilmiş zemin ve gelişmiş enerji altyapısına
          sahip modern tesisler inşa ediyoruz.
        </p>
        <h4 className="text-lg font-bold text-[#051328] border-b border-gray-200 pb-2">
          Hizmet Kapsamı:
        </h4>
        <ul className="space-y-2">
          <li className="flex gap-3">
            ...
            <span>
              <strong>Fizibilite:</strong> Bölgesel teşvik ve lojistik analizi.
            </span>
          </li>
          <li className="flex gap-3">
            <CheckCircle2 className="text-[#D4AF37] w-5 h-5 flex-shrink-0" />{" "}
            <span>
              <strong>Endüstriyel Tasarım:</strong> Vinç yolları ve yükleme
              rampaları.
            </span>
          </li>
          <li className="flex gap-3">
            <CheckCircle2 className="text-[#D4AF37] w-5 h-5 flex-shrink-0" />{" "}
            <span>
              <strong>Süreç Yönetimi:</strong> Ruhsat, iskan ve bürokrasi
              takibi.
            </span>
          </li>
        </ul>
  ...
  },
  {
    ...
    longDescription: (
      <div className="space-y-4">
        <p>
          Şehrin en değerli lokasyonlarında, modern mimari ve akıllı bina
          teknolojilerini birleştiren A+ ofis projeleri tasarlıyoruz. Kurumsal
          firmalar için yüksek prestij ve verimlilik sağlayan çalışma alanları
          sunuyoruz.
        </p>
        <h4 className="text-lg font-bold text-[#051328] border-b border-gray-200 pb-2">
          Öne Çıkanlar:
        ...
        <ul className="space-y-2">
          <li className="flex gap-3">
            <CheckCircle2 className="text-[#D4AF37] w-5 h-5 flex-shrink-0" />{" "}
            <span>
              <strong>Yüksek Kira Getirisi:</strong> Kurumsal kiracı garantisi.
            </span>
          </li>
          <li className="flex gap-3">
            <CheckCircle2 className="text-[#D4AF37] w-5 h-5 flex-shrink-0" />{" "}
            <span>
              <strong>Akıllı Altyapı:</strong> Fiber ağlar ve iklimlendirme
              sistemleri.
            </span>
          </li>
          <li className="flex gap-3">
            <CheckCircle2 className="text-[#D4AF37] w-5 h-5 flex-shrink-0" />{" "}
            <span>
              <strong>Merkezi Konum:</strong> Finans merkezlerine yürüme
              mesafesi.
            </span>
          </li>
        </ul>
  ...
  },
  {
    ...
    longDescription: (
      <div className="space-y-4">
        <p>
          Ham arazileri profesyonel planlama süreçleriyle inşaata hazır, yüksek
          değerli arsalara dönüştürüyoruz. Belediyelerle koordineli çalışarak
          18. Madde, ifraz ve tevhid işlemlerini uzman ekibimizle yönetiyoruz.
        </p>
        <h4 className="text-lg font-bold text-[#051328] border-b border-gray-200 pb-2">
          Süreç Detayları:
        </h4>
        <ul className="space-y-2">
          <li className="flex gap-3">
            <CheckCircle2 className="text-[#D4AF37] w-5 h-5 flex-shrink-0" />{" "}
            <span>
              <strong>İmar Analizi:</strong> 1/1000 ve 1/5000 plan takibi.
            </span>
          </li>
          <li className="flex gap-3">
            <CheckCircle2 className="text-[#D4AF37] w-5 h-5 flex-shrink-0" />{" "}
            <span>
              <strong>Kat Karşılığı:</strong> Adil paylaşım modelleri
              geliştirme.
            </span>
          </li>
          <li className="flex gap-3">
            <CheckCircle2 className="text-[#D4AF37] w-5 h-5 flex-shrink-0" />{" "}
            <span>
              <strong>Değer Artışı:</strong> Arazi vasfından arsa vasfına geçiş.
            </span>
          </li>
        </ul>
      </div>
  ...
  },
  {
    ...
    longDescription: (
      <div className="space-y-4">
        <p>
          Londra, Dubai ve Karadağ başta olmak üzere global pazarlarda döviz
          bazlı getiri sağlayan gayrimenkul fırsatları sunuyoruz. Hukuki
          süreçlerden oturum izni başvurularına kadar uçtan uca danışmanlık
          veriyoruz.
        </p>
        <h4 className="text-lg font-bold text-[#051328] border-b border-gray-200 pb-2">
          Fırsatlar:
        ...
        <ul className="space-y-2">
          <li className="flex gap-3">
            <CheckCircle2 className="text-[#D4AF37] w-5 h-5 flex-shrink-0" />{" "}
            <span>
              <strong>Dubai:</strong> Vergisiz kazanç ve yüksek kira getirisi.
            </span>
          </li>
          <li className="flex gap-3">
            <CheckCircle2 className="text-[#D4AF37] w-5 h-5 flex-shrink-0" />{" "}
            <span>
              <strong>Londra:</strong> Stabil pazar ve değer koruma.
            </span>
          </li>
          <li className="flex gap-3">
            <CheckCircle2 className="text-[#D4AF37] w-5 h-5 flex-shrink-0" />{" "}
            <span>
              <strong>Vatandaşlık:</strong> Yatırım yoluyla oturum programları.
            </span>
          </li>
        </ul>
      </div>
      ...
      {activeService && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white w-full max-w-xl max-h-[90vh] overflow-y-auto rounded-sm shadow-2xl animate-in zoom-in-95 duration-300">
            {/* GÜNCELLENEN KAPATMA BUTONU: Daha belirgin, marka renklerinde, gölgeli */}
            <button
              onClick={() => setActiveService(null)}
              className="absolute top-4 right-4 z-20 p-2.5 bg-[#051328] text-[#D4AF37] border border-[#D4AF37]/50 rounded-full shadow-lg hover:bg-red-600 hover:text-white hover:border-red-600 transition-all duration-300"
            >
              <X size={24} />
            </button>
