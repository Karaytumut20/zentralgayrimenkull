...
export default function IletisimPage() {
  ...
  // --- ANKARA DATALARI ---
  // Ankara için de tam adres linki eklendi
  const ankaraMapLink =
      ...
      <section className="py-20 container mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-gray-500 text-lg">
            Yatırım fırsatları hakkında detaylı bilgi almak için size en yakın
            ofisimizi ziyaret edebilir veya uzmanlarımızla iletişime
            geçebilirsiniz.
          </p>
        </div>
            ...
            <div className="w-full lg:w-1/2 space-y-8">
              <div>
                ...
                <p className="text-gray-500 leading-relaxed">
                  Karatay'ın kalbinde, prestijli projelerimizi yerinde
                  incelemeniz için sizleri bekliyoruz.
                </p>
              </div>
          ...
          <div className="flex flex-col lg:flex-row-reverse gap-16 items-center border-t border-gray-100 pt-20">
            ...
            <div className="w-full lg:w-1/2 space-y-8">
              <div>
                ...
                <p className="text-gray-500 leading-relaxed">
                  Başkent'teki yatırımlarınız ve projelerimiz için Çankaya
                  ofisimizde hizmetinizdeyiz.
                </p>
              </div>
