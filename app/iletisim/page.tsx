            ...
            <div className="w-full lg:w-1/2 space-y-8">
              ...
              <div className="space-y-6">
                <ContactItem
                  ...
                  lines={[
                    "Kumköprü Mahallesi",
                    "Küçükkumköprü Caddesi No: 176DC",
                    "Karatay / KONYA",
                  ]}
                  link={konyaMapLink}
                />
                ...
                <div className="flex items-start gap-4 group cursor-pointer">
                  ...
                  <div>
                    ...
                    <a
                      href="tel:+903322338042"
                      className="block text-gray-600 font-medium hover:text-[#051328] transition-colors"
                    >
                      0332 233 80 42{" "}
                    ...
                    <a
                      ...
                      className="block text-gray-600 font-medium hover:text-[#051328] transition-colors mt-1"
                    >
                      0501 333 80 42{" "}
                      <span className="text-gray-400 text-sm font-normal">
                        ({lang === "tr" ? "Mobil" : "Mobile"})
                      </span>
                    </a>
                  </div>
                </div>
                ...
                <ContactItem
                  ...
                  lines={[
                    "zentralgayrimenkul@gmail.com",
                    lang === "tr" ? "7/24 Bize Ulaşın" : "Contact us 24/7",
                  ]}
            ...
            <div className="w-full lg:w-1/2 space-y-8">
              ...
              <div className="space-y-6">
                ...
                <ContactItem
                  ...
                  title={lang === "tr" ? "E-Posta" : "E-Mail"}
                  lines={[
                    "zentralankara@gmail.com",
                    lang === "tr" ? "Ankara ofisi için" : "For Ankara office",
                  ]}
    ...
    >
      ...
      <div>
        ...
        {lines.map((line, index) => (
          <p
            key={index}
            className="text-gray-600 font-medium group-hover:text-gray-800 transition-colors text-sm lg:text-base"
          >
            {line}
          </p>
        ))}
    ...
    <div className="w-full lg:w-1/2 relative h-[400px] lg:h-[500px]">
      ...
      >
        ...
        <div className="absolute bottom-6 left-6 bg-white p-4 shadow-xl border-l-4 border-[#D4AF37] max-w-xs animate-in slide-in-from-bottom-5 duration-700 group-hover:scale-105 transition-transform">
          <h5 className="font-serif font-bold text-[#051328] text-lg mb-1">
            {locationName}
          </h5>
          <div className="flex items-center gap-2 text-[#D4AF37] font-bold text-xs tracking-widest uppercase hover:text-[#051328] transition-colors">
            {lang === "tr" ? "Yol Tarifi" : "Get Directions"}{" "}
            <Navigation size={12} />
          </div>
        </div>
