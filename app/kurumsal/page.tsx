...
import { 
  ShieldCheck, Users, Target, Building2, Handshake, Award, 
  ChevronRight, ChevronDown, Quote, Briefcase, ExternalLink
} from "lucide-react";
    ...
    <main className="bg-white text-slate-800">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            ...
            <div className="lg:w-1/2 relative w-full mt-8 lg:mt-0">
              ...
              <div className="absolute -bottom-6 -left-2 lg:-left-6 bg-yellow-600 text-white p-4 lg:p-6 rounded-xl shadow-xl">
                <p className="font-bold text-2xl lg:text-3xl">15+</p>
                <p className="text-[10px] lg:text-xs uppercase tracking-wider opacity-90">Yıllık Tecrübe</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-br from-slate-900 to-slate-800 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-6 relative z-10 flex flex-col items-center text-center">
          ...
          <div className="flex flex-col items-center justify-center text-center gap-1">
            ...
            <div className="text-yellow-500 text-xs lg:text-sm">Kurucu & Yönetim Kurulu Bşk.</div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4 lg:px-6">
          <div className="text-center mb-10 lg:mb-16">
            <h2 className="text-yellow-600 font-bold tracking-widest uppercase mb-3 text-xs lg:text-sm">BAŞARI YOLCULUĞUMUZ</h2>
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-slate-900">Konya'dan Dünyaya Açılan Kapı</h3>
          </div>
      ...
      <section className="py-12 lg:py-24 container mx-auto px-4 lg:px-6">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
          <div className="lg:w-1/3">
            <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 mb-4 lg:mb-6">Süreç Nasıl İşliyor?</h2>
        ...
        <div className="container mx-auto px-4 lg:px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-10">
            <div className="bg-white p-6 lg:p-8 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border-b-4 border-slate-900 group">
              ...
              <h3 className="text-lg lg:text-xl font-bold text-slate-900 mb-2 lg:mb-3">Güven Politikamız</h3>
            ...
            <div className="bg-white p-6 lg:p-8 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border-b-4 border-yellow-600 group">
              ...
              <h3 className="text-lg lg:text-xl font-bold text-slate-900 mb-2 lg:mb-3">Global Vizyon</h3>
              <p className="text-gray-600 text-sm lg:text-base">
            ...
            <div className="bg-white p-6 lg:p-8 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border-b-4 border-slate-900 group">
              ...
              <h3 className="text-lg lg:text-xl font-bold text-slate-900 mb-2 lg:mb-3">Uzman Kadro</h3>
              <p className="text-gray-600 text-sm lg:text-base">
      ...
      <section className="py-12 lg:py-24 container mx-auto px-4 lg:px-6">
         <div className="text-center mb-8 lg:mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-slate-900">Merak Edilenler</h2>
            <p className="text-gray-500 mt-2 text-base lg:text-lg">Aklınızdaki soruları şeffaflıkla yanıtlıyoruz.</p>
         </div>
         ...
         <div className="max-w-3xl mx-auto space-y-4">
            {faqData.map((item, index) => (
               ...
               >
                  ...
                  >
                    <span className={`font-bold text-base lg:text-lg ${activeFaq === index ? "text-white" : "text-slate-800"}`}>
                      {item.question}
                    </span>
                    <ChevronDown 
